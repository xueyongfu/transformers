...
class Sst2Processor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        # return ['正面', '负面', '中性']
        return ['公安政法类_公安(出入境):国家安全:检察院系统', '公安政法类_公安（治安、交通）_交通管理_交通事故',
       '公安政法类_公安（治安、交通）_交通管理_交通法规', '公安政法类_公安（治安、交通）_交通管理_交通设施',
       '公安政法类_公安（治安、交通）_交通管理_交通违章', '公安政法类_公安（治安、交通）_交通管理_排堵保畅',
       '公安政法类_公安（治安、交通）_交通管理_无主废弃车辆', '公安政法类_公安（治安、交通）_交通管理_车辆年检',
       '公安政法类_公安（治安、交通）_交通管理_过户上牌', '公安政法类_公安（治安、交通）_交通管理_限流限行',
       '公安政法类_公安（治安、交通）_交通管理_非法客运', '公安政法类_公安（治安、交通）_交通管理_驾驶员审验',
       '公安政法类_公安（治安、交通）_其他_其他', '公安政法类_公安（治安、交通）_户籍管理:特种行业管理_收养审批:黑网吧',
       '公安政法类_公安（治安、交通）_户籍管理_外省市迁入', '公安政法类_公安（治安、交通）_户籍管理_市内户口迁移',
       '公安政法类_公安（治安、交通）_户籍管理_户籍政策咨询', '公安政法类_公安（治安、交通）_户籍管理_死亡登记',
       '公安政法类_公安（治安、交通）_户籍管理_身份证管理', '公安政法类_公安（治安、交通）_特种行业管理_娱乐场所管理',
       '公安政法类_公安（治安、交通）_特种行业管理_行政许可', '公安政法类_公安（治安、交通）_犬类管理_养犬登记',
       ...
       '公安政法类_公安（治安、交通）_社会治安_刑事案件:游行集会:网络安全',
       '公安政法类_公安（治安、交通）_社会治安_危险品管理', '公安政法类_公安（治安、交通）_社会治安_居住证',
       '公安政法类_公安（治安、交通）_社会治安_治安维护', '公安政法类_公安（治安、交通）_社会治安_流浪人员管理',
       '公安政法类_公安（治安、交通）_社会治安_立案侦查', '公安政法类_公安（治安、交通）_社会治安_经济案件',
       '公安政法类_公安（治安、交通）_社会治安_黄赌毒', '公安政法类_公安（消防）_其他_其他',
       '公安政法类_公安（消防）_审批许可_审批许可', '公安政法类_公安（消防）_消防管理_易燃易爆物',
       '公安政法类_公安（消防）_消防管理_消防安全咨询', '公安政法类_公安（消防）_消防管理_消防宣传',
       '公安政法类_公安（消防）_消防管理_消防隐患', '公安政法类_公安（消防）_消防管理_火灾报警',
       '公安政法类_公安（消防）_消防管理_烟花爆竹管理', '公安政法类_公安（消防）_消防设备维护_消防栓',
       '公安政法类_公安（消防）_消防设备维护_消防通道', '公安政法类_公安（消防）_消防设备维护_火灾报警系统',
       '公安政法类_公安（消防）_消防设备维护_灭火器',
       '公安政法类_司法行政_公证服务:司法直属:法律服务_无犯罪证明:监狱管理:矫正办:司法鉴定:普法宣传',
       '公安政法类_司法行政_公证服务_其他公证', '公安政法类_司法行政_公证服务_继承权公证',
       '公安政法类_司法行政_其他_其他', '公安政法类_司法行政_法律服务_律师服务', '公安政法类_司法行政_法律服务_法律援助',
       '公安政法类_司法行政_纠纷仲裁_人民调解', '公安政法类_司法行政_纠纷仲裁_劳动争议',
       '公安政法类_司法行政_纠纷仲裁_经济纠纷', '公安政法类_国家安全_其他_其他',
       '公安政法类_法院系统_其他:法院信息:法院受理_其他:法院地址电话:诉讼立案',
       '公用事业类_供水:气象_违规用水:其他:气象预警_私移水表:其他:台风沙尘:道路结冰预警',
       '公用事业类_供水_供水报修_停水水小', '公用事业类_供水_供水报修_其他报修', '公用事业类_供水_供水报修_水管维修',
       '公用事业类_供水_供水报修_水表失窃', '公用事业类_供水_供水报修_水表维修', '公用事业类_供水_供水服务_业务办理',
       '公用事业类_供水_供水服务_信息查询', '公用事业类_供水_供水服务_服务质量', '公用事业类_供水_供水计费_水费量高',
       '公用事业类_供水_供水计费_缴费信息', '公用事业类_供水_供水计费_账单抄表', '公用事业类_供水_其他_其他',
       '公用事业类_供水_自来水水质_水中杂质', '公用事业类_供水_自来水水质_自来水异味',
       '公用事业类_供水_自来水水质_颜色异变', '公用事业类_供水_违规用水_私接自来水管',
       '公用事业类_气象_气象预报_天气预报:气象服务信息:环境气象:空气指数', '公用事业类_气象_气象预警_暴雨暴雪',
       '公用事业类_气象_气象预警_雷电预警', '公用事业类_气象_气象预警_高温预警', '公用事业类_燃气_其他_其他',
       '公用事业类_燃气_燃气报修:燃气计费_燃气火小:燃气配件:用量偏高:缴费信息:账单抄表',
       '公用事业类_燃气_燃气报修_燃气泄漏', '公用事业类_燃气_燃气报修_管道维修', '公用事业类_燃气_燃气服务_业务办理',
       '公用事业类_燃气_燃气服务_信息咨询', '公用事业类_燃气_燃气服务_安全检查', '公用事业类_燃气_燃气服务_服务质量',
       '公用事业类_燃气_燃气服务_燃气施工', '公用事业类_电力_其他_其他', '公用事业类_电力_故障报修_变电设施',
       '公用事业类_电力_故障报修_独户停电', '公用事业类_电力_故障报修_电线高压线', '公用事业类_电力_故障报修_电表维修',
       '公用事业类_电力_故障报修_规模停电', '公用事业类_电力_故障报修_路灯供电',
       '公用事业类_电力_用电计费:限电管理_分时用电:阶梯电价:节能用电', '公用事业类_电力_用电计费_电费争议',
       '公用事业类_电力_用电计费_缴费信息', '公用事业类_电力_电力服务_业务办理', '公用事业类_电力_电力服务_信息查询',
       '公用事业类_电力_电力服务_服务质量', '公用事业类_电力_立杆_无主立杆', '公用事业类_电力_违规用电_私排电线',
       '公用事业类_电力_违规用电_窃电举报', '公用事业类_邮政通信_其他_其他', '公用事业类_邮政通信_通信_业务办理',
       '公用事业类_邮政通信_通信_信息查询:服务质量:电视线路', '公用事业类_邮政通信_通信_故障报修',
       '公用事业类_邮政通信_通信_通信基站', '公用事业类_邮政通信_通信_通信线路', '公用事业类_邮政通信_邮政服务_其他业务',
       '公用事业类_邮政通信_邮政服务_快递服务', '公用事业类_邮政通信_邮政服务_服务质量:邮政发行',
       '公用事业类_邮政通信_邮政服务_邮件邮递', '其他类_“12345”热线_12345热线_信息咨询',
       '其他类_“12345”热线_其他_其他',
       '其他类_“12345”热线_意见建议:表扬感谢_业务范畴:平台系统:服务流程:业务熟练:办事效率',
       '其他类_“12345”热线_批评承办部门_办事效率', '其他类_“12345”热线_批评承办部门_服务态度',
       '其他类_“12345”热线_批评承办部门_诉求未解决', '其他类_“12345”热线_批评承办部门_问题推脱',
       '其他类_“12345”热线_投诉批评_业务熟练', '其他类_“12345”热线_投诉批评_办事效率',
       '其他类_“12345”热线_投诉批评_承办推诿', '其他类_“12345”热线_投诉批评_服务态度',
       '其他类_“12345”热线_投诉批评_问题解决', '其他类_“12345”热线_表扬感谢_服务态度',
       '其他类_“12345”热线_表扬感谢_问题解决', '其他类_“12345”热线_表扬承办部门_表扬感谢',
       '其他类_中央直属:其他:工青妇工作:涉港澳台:部队_中央直属:其他:无效电话:工青妇工作:涉港澳台:部队_中央直属机构信息:其他:外省市受理:无明确诉求:工青妇工作:涉台问题:涉军问题:证件办理',
       '其他类_信访_事项办理_办理结果不满', '其他类_信访_事项办理_无答复意见', '其他类_信访_其他_其他',
       '其他类_信访_咨询信访渠道_咨询信访渠道', '其他类_信访_复查复核_催办:结论不满', '其他类_信访_复查复核_流程指引',
       '其他类_信访_查询办理进度_查询办理进度', '其他类_其他_其他_其他', '其他类_其他_无效电话_无效来电',
       '其他类_机关事务管理_其他_其他', '其他类_机关事务管理_机关事务管理_公务车',
       '其他类_机关事务管理_机关事务管理_机关事务信息', '其他类_机关事务管理_机关事务管理_机关事务工作',
       '其他类_残联_其他_其他', '其他类_残联_残联_助残信息', '其他类_残联_残联_无障碍工程',
       '其他类_残联_残联_残疾补助', '其他类_残联_残联_残疾鉴定', '其他类_残联_残联_残联工作',
       '其他类_纪检监察_其他_其他', '其他类_纪检监察_政风行风_不作为', '其他类_纪检监察_政风行风_乱作为',
       '其他类_纪检监察_政风行风_办事推诿', '其他类_纪检监察_政风行风_慢作为', '其他类_纪检监察_政风行风_服务态度',
       '其他类_纪检监察_政风行风_违规收费', '其他类_纪检监察_纪检监查_作风问题', '其他类_纪检监察_纪检监查_失职渎职',
       '其他类_纪检监察_纪检监查_徇私枉法', '其他类_纪检监察_纪检监查_贪污贿赂', '其他类_部队_其他_其他',
       '安全监管类_安全生产管理:食品药品安全_安全生产:安全管理_安全生产宣传:应急救援:化妆品管理',
       '安全监管类_安全生产管理_其他_其他', '安全监管类_安全生产管理_安全生产_安全生产监督',
       '安全监管类_安全生产管理_职业健康_职业健康', '安全监管类_质量技术监督_其他_其他',
       '安全监管类_质量技术监督_特种设备监察_人员资质', '安全监管类_质量技术监督_特种设备监察_安全监察',
       '安全监管类_质量技术监督_生产许可证管理:组织机构代码证_生产许可证管理:组织机构代码证',
       '安全监管类_质量技术监督_申诉举报_申诉举报', '安全监管类_质量技术监督_计量器具检测_计量器具检测',
       '安全监管类_质量技术监督_质量认证_质量认证', '安全监管类_食品药品安全_其他_其他',
       '安全监管类_食品药品安全_安全管理_保健品管理', '安全监管类_食品药品安全_安全管理_医疗器械管理',
       '安全监管类_食品药品安全_安全管理_药品安全', '安全监管类_食品药品安全_安全管理_资质认证',
       '安全监管类_食品药品安全_安全管理_食品安全', '安全监管类_食品药品安全_广告审批_广告审批',
       '建设交通类_交通港口_停车管理_公共停车场', '建设交通类_交通港口_停车管理_经营性停车场',
       '建设交通类_交通港口_公交巴士_服务规范', '建设交通类_交通港口_公交巴士_线路咨询',
       '建设交通类_交通港口_公交巴士_线路设置', '建设交通类_交通港口_公共交通用卡管理_交通卡',
       '建设交通类_交通港口_公共交通用卡管理_老年卡', '建设交通类_交通港口_其他_其他',
       '建设交通类_交通港口_出租车_服务规范', '建设交通类_交通港口_出租车_物品遗失', '建设交通类_交通港口_出租车_黑车',
       '建设交通类_交通港口_地铁客运:汽车客运:汽车维修:港船客运:航空客运:货物运输:车牌拍卖:铁路客运_线路时间:票务:故障牵引:省际轮渡:航班延误:飞机票务:航空运输:车牌拍卖:车次信息:铁路票务',
       '建设交通类_交通港口_地铁客运_地铁建设', '建设交通类_交通港口_汽车客运_违规运营',
       '建设交通类_交通港口_汽车维修_4s店服务', '建设交通类_交通港口_港船客运_浦江轮渡',
       '建设交通类_交通港口_货物运输_搬场公司', '建设交通类_交通港口_货物运输_集装箱运输',
       '建设交通类_交通港口_驾驶培训_二次收费', '建设交通类_交通港口_驾驶培训_合同履行',
       '建设交通类_交通港口_驾驶培训_教练服务、培训规范', '建设交通类_住房保障_住房病虫害_白蚁',
       '建设交通类_住房保障_住房病虫害_鼠患', '建设交通类_住房保障_保障型住房_公租房',
       '建设交通类_住房保障_保障型住房_廉租房', '建设交通类_住房保障_保障型住房_经适房', '建设交通类_住房保障_其他_其他',
       ...
       '建设交通类_住房保障_物业服务管理_群租现象',
       '建设交通类_口岸:民防:水务_其他:口岸信息:防灾抗灾:水资源管理_其他:口岸信息:地震:非上水供水',
       ...
       '建设交通类_民防_民防工程_工程规划:民防警报', '建设交通类_民防_防灾抗灾_抗台防汛', '建设交通类_水务_其他_其他',
       '建设交通类_水务_排水排污管理_下水道养护', '建设交通类_水务_排水排污管理_不明归属井盖',
       '建设交通类_水务_排水排污管理_市政道路积水', '建设交通类_水务_排水排污管理_排水工程',
       '建设交通类_水务_排水排污管理_排污许可证', '建设交通类_水务_排水排污管理_水务工程建设',
       '建设交通类_水务_排水排污管理_污水冒溢', '建设交通类_水务_水资源管理_农业水利',
       '建设交通类_水务_水资源管理_地表地下水', '建设交通类_水务_水资源管理_水资源信息',
       '建设交通类_水务_水资源管理_河道水质', '建设交通类_水务_河道流域管理_水上漂浮物',
       ...
       '建设交通类_绿化市容_绿地绿化_非法经营利用',
       '社会团体类_其他:团市委:总工会_其他社团:团市委:总工会_民间慈善:青少年保护:劳模', '社会团体类_其他_其他_其他',
       '社会团体类_其他_其他社团_动物保护机构', '社会团体类_其他_其他社团_红十字会', '社会团体类_团市委_其他_其他',
       '社会团体类_团市委_团市委_团委工作', '社会团体类_妇联_其他:妇联_其他:妇女健康:妇女权益维护:妇联工作',
       '社会团体类_总工会_其他_其他', '社会团体类_总工会_总工会_工会工作', '社会团体类_总工会_总工会_职工权益',
       '社会管理类_人力保障_其他_其他', '社会管理类_人力保障_劳动人事制度_公务员管理',
       '社会管理类_人力保障_劳动人事制度_养老金调整', '社会管理类_人力保障_劳动人事制度_劳务派遣',
       '社会管理类_人力保障_劳动人事制度_工作调动', '社会管理类_人力保障_劳动人事制度_工时假期',
       '社会管理类_人力保障_劳动人事制度_工资奖金', '社会管理类_人力保障_劳动人事制度_工龄核算',
       '社会管理类_人力保障_劳动人事制度_职称评定', '社会管理类_人力保障_劳动人事制度_退休离休',
       '社会管理类_人力保障_劳动保护:医疗医保:就业创业:津贴补助:社保信息_特殊工种:医保药品目录:转业干部:事业单位共享费:退休证',
       '社会管理类_人力保障_劳动保护_合同纠纷', '社会管理类_人力保障_劳动保护_拖欠工资',
       '社会管理类_人力保障_劳动保护_最低工资', '社会管理类_人力保障_劳动保护_用工规范',
       '社会管理类_人力保障_劳动保护_经济补偿', '社会管理类_人力保障_医疗医保_医保定点',
       '社会管理类_人力保障_医疗医保_医保报销', '社会管理类_人力保障_医疗医保_医保政策咨询',
       '社会管理类_人力保障_就业创业_人才引进', '社会管理类_人力保障_就业创业_创业扶持',
       '社会管理类_人力保障_就业创业_劳务中介', '社会管理类_人力保障_就业创业_就业信息',
       '社会管理类_人力保障_就业创业_职业培训', '社会管理类_人力保障_工伤_劳动能力鉴定',
       '社会管理类_人力保障_工伤_工伤认定', '社会管理类_人力保障_津贴补助_丧葬补助金',
       '社会管理类_人力保障_津贴补助_其他补助', '社会管理类_人力保障_津贴补助_培训补贴',
       '社会管理类_人力保障_津贴补助_就业补贴', '社会管理类_人力保障_津贴补助_高温津贴',
       '社会管理类_人力保障_社会保险_养老保险', '社会管理类_人力保障_社会保险_医疗保险',
       '社会管理类_人力保障_社会保险_失业保险', '社会管理类_人力保障_社会保险_工伤保险',
       '社会管理类_人力保障_社会保险_生育保险', '社会管理类_人力保障_社保信息_受理网点',
       '社会管理类_人力保障_社保信息_居住证', '社会管理类_人力保障_社保信息_社保卡',
       '社会管理类_人力保障_社保信息_账户信息',
       '社会管理类_侨务:合作交流:工商(消保):档案:民政:民族宗教:知识产权_侨务工作:其他:合作交流:商业服务:国有档案:救灾赈灾:寺庙管理:知识产权_侨胞投资扶持:其他:合作交流:抵押拍卖:电视购物:服务质量:救灾物资分配:人员管理:寺庙用品:收费标准:秩序维护',
       '社会管理类_合作交流_其他_其他', '社会管理类_外事_其他:外事工作_其他:国际会议:外宾来访:领事馆',
       '社会管理类_工商(消保)_其他_其他', '社会管理类_工商(消保)_商业服务_各类服务卡券',
       '社会管理类_工商(消保)_商业服务_售后服务', '社会管理类_工商(消保)_商业服务_商品质量',
       '社会管理类_工商(消保)_商业服务_服务质量', '社会管理类_工商(消保)_商业服务_活禽交易',
       ...
       '社会管理类_旅游_其他_其他', '社会管理类_旅游_旅游信息_上海旅游节:旅行社信息',
       '社会管理类_旅游_旅游信息_景点投诉', '社会管理类_旅游_旅游信息_景点资讯', '社会管理类_旅游_旅游纠纷_强制消费',
       '社会管理类_旅游_旅游纠纷_旅游合同纠纷', '社会管理类_旅游_服务质量_导游服务:旅游交通',
       ...
       '社会管理类_档案_国有档案_档案公开', '社会管理类_民政_优抚安置_军人伤残优抚',
       ...
       '社会管理类_民政_慈善福利_孤儿收养:福利企业扶持', '社会管理类_民政_慈善福利_慈善募捐',
       '社会管理类_民政_慈善福利_福利设施', '社会管理类_民政_救灾赈灾_社会捐献', '社会管理类_民政_殡葬事业_墓园管理',
       '社会管理类_民政_殡葬事业_殡葬服务', '社会管理类_民政_生活保障_扶贫帮困', '社会管理类_民政_生活保障_最低生活保障',
       '社会管理类_民政_生活保障_流浪救助', '社会管理类_民政_生活保障_经济状况审核', '社会管理类_民政_社区家政_家政服务',
       '社会管理类_民政_社区家政_社区服务网点', '社会管理类_民政_社区家政_社工管理', '社会管理类_民族宗教_其他_其他',
       '社会管理类_民族宗教_宗教信仰_宗教信仰', '社会管理类_知识产权_其他_其他', '社会管理类_知识产权_知识产权_侵权行为',
       '社会管理类_知识产权_知识产权_申请专利', '社会管理类_社区综合服务_社区综合治理_党群工作',
       '社会管理类_社区综合服务_社区综合治理_平安建设', '社会管理类_社区综合服务_社区综合治理_群体事件',
       '社会管理类_社区综合服务_社区综合治理_重大传染病疫情',
       '科教文卫类_体育:教育:文广影视:科技_体育管理:招生考试:文化遗产保护:科技开发:科技管理_体育彩票:队伍建设:研究生考试:非物质文化遗产:发明建议:自主研发:科技改革',
       '科教文卫类_体育_体育管理_信鸽', '科教文卫类_体育_体育管理_场地设施', '科教文卫类_体育_体育管理_群众锻炼',
       '科教文卫类_体育_体育管理_赛事管理', '科教文卫类_体育_体育管理_青少年锻炼', '科教文卫类_体育_其他_其他',
       '科教文卫类_卫生计生_人口计生_业务办理', '科教文卫类_卫生计生_人口计生_优生优育',
       '科教文卫类_卫生计生_人口计生_再生育政策', '科教文卫类_卫生计生_人口计生_婚前检查:超生处罚:避孕节育',
       '科教文卫类_卫生计生_人口计生_独生子女补贴', '科教文卫类_卫生计生_人口计生_网点查询',
       '科教文卫类_卫生计生_人口计生_计生宣传', '科教文卫类_卫生计生_其他_其他', '科教文卫类_卫生计生_医疗服务_住院病床',
       '科教文卫类_卫生计生_医疗服务_医疗设备', '科教文卫类_卫生计生_医疗服务_护工护理',
       '科教文卫类_卫生计生_医疗服务_排队挂号', '科教文卫类_卫生计生_医疗服务_服务态度',
       '科教文卫类_卫生计生_医疗服务_用药规范', '科教文卫类_卫生计生_医院监管_医疗纠纷',
       '科教文卫类_卫生计生_医院监管_职业资质许可', '科教文卫类_卫生计生_医院监管_非法行医',
       '科教文卫类_卫生计生_卫生信息_医药卫生知识', '科教文卫类_卫生计生_卫生信息_医院医疗信息',
       '科教文卫类_卫生计生_卫生信息_疾控防疫', '科教文卫类_卫生计生_卫生信息_社区卫生服务',
       '科教文卫类_卫生计生_特定医疗机构_临终关怀', '科教文卫类_卫生计生_特定医疗机构_体检中心',
       '科教文卫类_卫生计生_特定医疗机构_器官捐赠:采血机构', '科教文卫类_卫生计生_特定医疗机构_妇婴保健',
       ...
       '科教文卫类_教育_招生考试_居住证', '科教文卫类_教育_招生考试_成人教育', '科教文卫类_教育_招生考试_职业技能考试',
       '科教文卫类_教育_招生考试_高考', '科教文卫类_文广影视_其他_其他', '科教文卫类_文广影视_广播影视_东方有线',
       '科教文卫类_文广影视_广播影视_广播:网络视听', '科教文卫类_文广影视_广播影视_影视节目',
       ...
       '科教文卫类_新闻出版_其他_其他', '科教文卫类_新闻出版_刊物市场监管:新闻报道_刊社信息:科教书:记者证管理',
       '科教文卫类_新闻出版_刊物市场监管_图书刊物出版', '科教文卫类_新闻出版_刊物市场监管_报刊印刷发行',
       '科教文卫类_新闻出版_新闻报道_新闻内容', '科教文卫类_科技_其他_其他', '科教文卫类_科技_科技管理_高新技术扶持',
       '经济综合类_农业_其他_其他', '经济综合类_农业_农业生产:农民负担:动植物防疫_转基因产品（有机食品）:国家收购:防疫补贴',
       '经济综合类_农业_农业生产_农产品安全', '经济综合类_农业_农业生产_农副业生产',
       '经济综合类_农业_农业生产_土地建设与保护', '经济综合类_农业_农业生产_滥砍滥捕',
       '经济综合类_农业_农业生产_畜牧养殖', '经济综合类_农业_农民负担_农业补贴', '经济综合类_农业_动植物防疫_兽医药管理',
       '经济综合类_农业_动植物防疫_疫情防疫', '经济综合类_农业_村队管理_吸劳养老', '经济综合类_农业_村队管理_土地承包',
       '经济综合类_农业_村队管理_征地补偿', '经济综合类_农业_村队管理_撤制村队', '经济综合类_农业_村队管理_集体资产管理',
       '经济综合类_发展改革:统计:财政_改革规划:统计工作:财政工作_医疗改革:能源发展:资质证书:财政票据',
       '经济综合类_发展改革_价格调控_公共事业', '经济综合类_发展改革_价格调控_医疗服务',
       '经济综合类_发展改革_价格调控_市场物价', '经济综合类_发展改革_价格调控_物业管理收费',
       '经济综合类_发展改革_其他_其他', '经济综合类_发展改革_改革规划_新能源汽车', '经济综合类_商务_其他_其他',
       '经济综合类_商务_商务_商贸信息', '经济综合类_商务_商务_市场供应', '经济综合类_商务_商务_烟草酒类',
       '经济综合类_国资_其他_其他', '经济综合类_国资_国资_企业改革:国有资产流失:投资决策',
       '经济综合类_国资_国资_企业解困', '经济综合类_国资_国资_国企管理', '经济综合类_审计_其他:审计工作_其他:审计工作',
       '经济综合类_税务_其他_其他', '经济综合类_税务_税收政策:税收管理_个人所得税:营业税改增值税:假发票:虚开发票',
       '经济综合类_税务_税收政策_企业征税', '经济综合类_税务_税收政策_其他税种', '经济综合类_税务_税收政策_房产交易税',
       '经济综合类_税务_税收管理_偷税漏税', '经济综合类_经济信息化_其他_其他',
       '经济综合类_经济信息化_经济信息化_城市信息化', '经济综合类_经济信息化_经济信息化_循环再利用:法人一证通',
       '经济综合类_经济信息化_经济信息化_节能减排', '经济综合类_统计_其他_其他', '经济综合类_财政_其他_其他',
       '经济综合类_财政_财政工作_财会考证', '经济综合类_金融_其他_其他',
       '经济综合类_金融_金融_保险监管:证券监管:资产评估:银行监管', '经济综合类_金融_金融_金融资讯']
